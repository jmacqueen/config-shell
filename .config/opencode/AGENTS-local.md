...
- **All Bitsight repos use GitLab** (gitlab.com), not GitHub
- Always load the `glab-gitlab` skill when MR/PR/merge request/code review work is mentioned
- Never attempt `gh` commands without first verifying the repo is on GitHub
- Check git remote if uncertain: `git remote -v`
